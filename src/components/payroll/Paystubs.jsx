...
import { getShiftsInDateRangeByUser } from "../../services/shiftService"
import { PayrollDisplay } from "./PayrollDisplay"


export const Paystubs = ({ currentUser }) => {
    ...
    const getAndSetShifts = () => {
        getShiftsInDateRangeByUser(currentUser.id, startDate, endDate).then((shiftArray) => {
